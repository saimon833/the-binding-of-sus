...
Obstacle::Obstacle(b2World *world, SDL_Renderer *ren, CommonResources &commonResources) {
    ...
    m_posiotion.x = random(m_commonResources->gameProperties.window_w) - m_commonResources->gameProperties.spiriteSize;
    m_posiotion.y= random(m_commonResources->gameProperties.window_h) - m_commonResources->gameProperties.spiriteSize;
    ...
    myBodyDef.position.Set(m_posiotion.x+ 32, m_posiotion.y + 32);
    myBodyDef.angle = 0;
